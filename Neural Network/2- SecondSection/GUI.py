...
from SecondSection.Regressor import Regressor_Simple
...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def set_values(self):
        ...
        reg.noise_mult = float(self.noise_in.text())
        reg.function = lambda x: eval(self.function_text.text())

    def make_dataset(self):
        self.regressor.initial_dataset_maker(True)
